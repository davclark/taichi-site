			...
			_elm_lang$html$Html$option,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(num, selectedNum)),
					_1: {ctor: '[]'}
				}
			},
			{
						...
						_elm_lang$core$List$append,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _davclark$taichi_site$MyVideo$onEnded(_davclark$taichi_site$MyVideo$AdvanceVid),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _davclark$taichi_site$MyVideo$SetVidNumStr = function (a) {
			...
			_elm_lang$core$List$concat(
				{
					...
					_0: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], model.label, ': ')),
						_1: {ctor: '[]'}
					},
					_1: {
						ctor: '::',
			...
			switch (_p5.ctor) {
				case 'SetVidNum':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{selected: _p5._0, autoplay: false}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'SetVidNumStr':
					var num = _elm_lang$core$String$toInt(_p5._0);
					var _p6 = num;
					if (_p6.ctor === 'Ok') {
						var _v5 = _davclark$taichi_site$MyVideo$SetVidNum(_p6._0),
							_v6 = model;
						msg = _v5;
						model = _v6;
						continue update;
				...
				case 'AdvanceVid':
					return (model.autoadvance && (_elm_lang$core$Native_Utils.cmp(
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{selected: model.selected + 1, autoplay: true}),
						_1: _elm_lang$core$Platform_Cmd$none
				...
				default:
					if (_p5._0.ctor === 'Ok') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{videos: _p5._0._0, status: 'Updated'}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									status: _elm_lang$core$Basics$toString(_p5._0._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
...
var _davclark$taichi_site$Main$init = {
	ctor: '_Tuple2',
	_0: A2(_davclark$taichi_site$MyVideo$init, 'Extra materials', true),
	_1: _davclark$taichi_site$MyVideo$getClassInfo('extra')
};
var _davclark$taichi_site$Main$main = _elm_lang$html$Html$program(
	{init: _davclark$taichi_site$Main$init, view: _davclark$taichi_site$MyVideo$view, update: _davclark$taichi_site$MyVideo$update, subscriptions: _davclark$taichi_site$Main$subscriptions})();
